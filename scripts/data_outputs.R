...
source("../../peacebuilding-language/blog/globals.R")
...
pub_count_year_search %>% 
  mutate(is.peacebuilding = ifelse(search_name=="peacebuilding", TRUE, FALSE)) %>% 
ggplot(aes(search_name, n, fill = is.peacebuilding))+
  geom_boxplot(show.legend = F)+
  labs(x= "Search terms", y="Yearly counts")+
  theme_minimal()
